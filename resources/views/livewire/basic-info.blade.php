<div class="relative isolate overflow-hidden bg-gray-900 w-[100vw] px-8 py-8 sm:py-8 ">
    ...
    <div class=" max-w-7xl px-6 lg:px-8">
        <div class="max-w-2xl lg:mx-0">
            <h2 class="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Work through us</h2>
            <p class="mt-4 text-lg font-medium text-gray-300 sm:text-xl">
        ...
        <div class=" mt-4 max-w-2xl lg:mx-0 lg:max-w-none">
            <dl class="mt-4 grid grid-cols-1 gap-8 sm:mt-4 sm:grid-cols-2 lg:flex lg:justify-between">
                <div class="flex flex-col-reverse gap-1">
                    ...
                    <dd class="text-4xl font-semibold tracking-tight text-white">{{$job }}</dd>
                </div>
                <div class="flex flex-col-reverse gap-1">
                    <dt class="text-base text-gray-300">Categories</dt>
                    <dd class="text-4xl font-semibold tracking-tight text-white">{{ $tag }}+</dd>
                </div>
                <div class="flex flex-col-reverse gap-1">
                    <dt class="text-base text-gray-300">Companies</dt>
                    <dd class="text-4xl font-semibold tracking-tight text-white">{{ $company }}+</dd>
                </div>
                <div class="flex flex-col-reverse gap-1">
