<div
    ...
    <div
        ...
        <h2 class="text-2xl font-bold font-serif pb-4 bg-gradient-to-r from-green-500 via-cyan-500 to-blue-500 bg-clip-text text-transparent">Edit Profile Information</h2>
        ...
        <div class="w-full flex justify-between px-8">
            <div>
                ...
                <x-form.input-field wire:model.defer="name" wire:keydown.enter="updateData" wire:blur="updateData"
                ...
                <x-form.input-field name="email" wire:model.defer="email" wire:keydown.enter="updateData" wire:blur="updateData"
            ...
            <div class="px-8">
                ...
                <x-form.input-field name="cname" wire:model.defer="cname" wire:keydown.enter="updateData" wire:blur="updateData"
                    class="!px-4 !py-2 !bg-transparent !border-none !outline-none font-bold !bg-none !text-black/70 appearance-none focus:ring-2 focus:ring-purple-300 !hover:bg-gray-500 my-2 !text-xl" />
                <h2 class="font-semibold text-lg font-serif">Company Address</h2>
                <x-form.input-field name="location" wire:model.defer="location" wire:keydown.enter="updateData" wire:blur="updateData"
                    class="!px-4 !py-2 !bg-transparent !border-none !outline-none font-bold !bg-none !text-black/70 appearance-none focus:ring-2 focus:ring-purple-300 !hover:bg-gray-500  my-2 !text-xl" />
            </div>
        </div>
